...
const onChange = (e) =>
  ...
  // errors.end_date = "End date must be superior to Today date ";
   ...
   if (price_per_share===0) {
    ...
    errors.price_per_share = "Price per share cannot be superior to amount collect";
...
today = yyyy+'-'+mm+'-'+dd;
    ...
    return (<> 
      ...
      <h1 style={{display: 'flex',  justifyContent:'center', alignItems:'center',color:'#F57C00'}}>Create Project</h1>
...
<div>
                      <button type="submit"  disabled={setIsSubmit} class="newUserButton">Create </button>
                      </div><br></br>
                  </div>
              </form>
          </div>
